...
function medirLadrilho(nomes, passoPadrao = 320, alturaPadrao = 190) {
    const estilo = getComputedStyle(document.getElementById('arena'));
    return {
        passo: parseFloat(estilo.getPropertyValue(nomes[0])) || passoPadrao,
        altura: parseFloat(estilo.getPropertyValue(nomes[1])) || alturaPadrao,
    };
}
