...
{
    /// <summary>
    /// Zumbi — apóstolo como DADO (ver ADR-composicao-de-acoes §10), vocabulário puro (Nível 1).
    ...
    /// isso a explosão é reutilizável a seco por outros apóstolos. Passiva: "Horda" (EscalaComMortos)
