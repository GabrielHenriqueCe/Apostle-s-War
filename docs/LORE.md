# LORE — Apostle's War (ago/2026)

A premissa é do Gabriel, e nasceu de um problema de nomenclatura: **se o jogo se chama *Apostle's
War* e todo herói é um apóstolo, então não pode existir uma FACÇÃO chamada Apóstolos.** A conta não
fecha. Resolver isso destravou a história inteira.
...
- **O 👑 Reino não é rival no capítulo 1 — eles estão TREINANDO o jogador.** Só depois passam a lutar
  ao lado dele.

---

## O QUE A PREMISSA EXPLICA — mecânicas que já existiam sem justificativa

Isso é o teste de que ela é a certa: ela não foi inventada por cima do jogo, ela **descreve o jogo
que já está lá**.
...
Nove, na ordem da campanha. Os Humanos são o time inicial, não um capítulo.

| | facção | o que é |
|---|---|---|
| 🛠️ | **Humanos** | as peças do mundo do jogador — a Terra. Invocaram o apóstolo |
| 👑 | Reino | quem o recebe, e quem o **treina** |
| 🌑 | Lado Sombrio | |
| ⚙️ | Tecnológicos | chegam como **invasão**, não como civilização |
| 🪬 | Folclore | |
| 🐉 | Místicos | |
| ⭐ | Especial | o absurdo é **permitido de propósito** — piada não é problema |
